...
class Uniteller extends BasePayment
{
    ...
    public function sendbank(OrderInterface $order)
    {
        ...
        return new Response('<div style="width:400px; height: 400px;">'.$response->getContent().'</div><iframe style="width:400px; height: 400px;" name="pay_iframe">'.$response->getContent().'</iframe>');
    }
